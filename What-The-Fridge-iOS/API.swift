      ...
      public struct User: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            ...
            GraphQLField("imgUrl", type: .nonNull(.scalar(String.self))),
        ...
        public init(id: Double, firebaseUserUid: String, firstName: String, lastName: String, email: String, imgUrl: String, tier: Double, createdAt: String, updatedAt: String) {
...
public final class GetAllUsersQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct GetAllUser: GraphQLSelectionSet {
      ...
      public init(id: Double, firebaseUserUid: String, firstName: String, lastName: String, imgUrl: String, email: String, tier: Double, createdAt: String, updatedAt: String) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "firebaseUserUID": firebaseUserUid, "firstName": firstName, "lastName": lastName, "imgUrl": imgUrl, "email": email, "tier": tier, "createdAt": createdAt, "updatedAt": updatedAt])
      }
